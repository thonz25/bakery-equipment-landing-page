    ...
    <div className="container about-page">
      ...
      >
        ...
        <div className="card">
          <h2>Restoration</h2>
          <p>
            We can restore your equipment to like-new condition. We can diagnose
            and repair any issue you may be experiencing with your equipment.
            From routine maintenance to complex repairs, we have the knowledge
            and expertise to get your equipment running smoothly again.
          </p>
        </div>
        <div className="card">
          <h2>Made to order</h2>
          <p>
            ...
            requirements. Let us know what you need and we'll build it for you.
          </p>
        </div>
        <div className="card">
          <h2>Home service</h2>
          <p>
            Don't have time to bring your equipment to us? No problem. We offer
            home service repairs, so you can get back to work without having to
            leave your business. We'll come to you and get the job done right
            the first time.
          </p>
        </div>
      </div>
